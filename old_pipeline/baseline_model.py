...
data_path = os.path.join(base_dir, "../dataset/FloodPrediction(excel).csv")
...
# Create directories
report_dir = os.path.join(base_dir, "baseline_performance_report")
...
# Save report
report_path = os.path.join(report_dir, f"{name.replace(' ', '_')}_classification_report.csv")
